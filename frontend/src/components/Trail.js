...
//         if (questionId) {
//             fetch(`http://localhost:4000/Qna/api/questions/${questionId}/answers`)
//                 .then(response => response.json())
//                 .then(answersData => {
...
//         fetch(`http://localhost:4000/Qna/upvote/${questionId}`, { method: 'POST' })
//             .then(response => response.json())
//             .then(data => {
...
//         fetch(`http://localhost:4000/Qna/downvote/${questionId}`, { method: 'POST' })
//             .then(response => response.json())
//             .then(data => {
//                 console.log(data.message);
            ...
            <div className="container" id="questionList">
                {questions.map(question => (
                    <div key={question.id} className="question">
                        ...
                        <div className="tags">
                            {question.tag1 && (
                                <button className="tag">#{question.tag1}</button>
                            )}
                            {question.tag2 && (
                                <button className="tag">#{question.tag2}</button>
                            )}
                            {question.tag3 && (
                                <button className="tag">#{question.tag3}</button>
                            )}
                        </div>
