...
app.post('/projects/:project_id/sprints/:sprint_id/issues', (req, res) => {
    ...
    connection.query('INSERT INTO issues (sprint_id, description, status, owner_id, points) VALUES (?, ?, "Todo", ?, ?)', [sprintId, issue.description, issue.owner_id, issue.points], (err, results) => {
        if (err) {
